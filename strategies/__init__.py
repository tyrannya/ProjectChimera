...
The Freqtrade strategy package. Disconnected at S3 by PR-13 under section 3.3
of ``docs/proposed_demo_implementation_master_plan.md``. Kept, tested and
reachable in the history; not imported by ``chimera.demo``, ``chimera.carry``,
