...
5 run(s), read from disk. Sealed test block starts at row 48217 (2025-08-27T23:00:00+00:00) and is not opened by this tool.

| run | path | seed | folds | research contract | research input | integrity |
| --- | --- | --- | --- | --- | --- | --- |
| btc_nested_v4_seed_42 | `artifacts/walkforward/btc_nested_v4_seed_42/walkforward.json` | 42 | 4 | research contract btc-usdt-1h-gen1@dca6d0a891a25719 | research input sha256:1c09218442cdf98c | ok |
| btc_nested_v4_seed_142 | `artifacts/walkforward/btc_nested_v4_seed_142/walkforward.json` | 142 | 4 | research contract btc-usdt-1h-gen1@dca6d0a891a25719 | research input sha256:1c09218442cdf98c | ok |
| btc_nested_v4_seed_242 | `artifacts/walkforward/btc_nested_v4_seed_242/walkforward.json` | 242 | 4 | research contract btc-usdt-1h-gen1@dca6d0a891a25719 | research input sha256:1c09218442cdf98c | ok |
| btc_nested_v4_seed_342 | `artifacts/walkforward/btc_nested_v4_seed_342/walkforward.json` | 342 | 4 | research contract btc-usdt-1h-gen1@dca6d0a891a25719 | research input sha256:1c09218442cdf98c | ok |
| btc_nested_v4_seed_442 | `artifacts/walkforward/btc_nested_v4_seed_442/walkforward.json` | 442 | 4 | research contract btc-usdt-1h-gen1@dca6d0a891a25719 | research input sha256:1c09218442cdf98c | ok |
...
| majority_baseline | annualised_sharpe | -4.2268 | 0 | -4.2268 | -4.2268 |
| majority_baseline | per_trade_sharpe | -0.11225 | 0 | -0.11225 | -0.11225 |
| majority_baseline | exposure | 0.996525 | 0 | 0.996525 | 0.996525 |
...
| momentum_baseline | annualised_sharpe | -5.7938 | 0 | -5.7938 | -5.7938 |
| momentum_baseline | per_trade_sharpe | -0.152275 | 0 | -0.152275 | -0.152275 |
| momentum_baseline | exposure | 0.996525 | 0 | 0.996525 | 0.996525 |
| momentum_baseline | max_drawdown | 0.818375 | 0 | 0.818375 | 0.818375 |
| mtst | macro_f1 | 0.158465 | 0.006012 | 0.15265 | 0.168575 |
| mtst | directional_accuracy | 0.52944 | 0.03181 | 0.495025 | 0.576525 |
| mtst | coverage | 0.03394 | 0.00688 | 0.026325 | 0.045075 |
| mtst | calibration_error | 0.101385 | 0.016473 | 0.082325 | 0.11715 |
| mtst | n_trades | 69.4 | 6.65348 | 58.75 | 75.5 |
| mtst | net_return | -0.019272 | 0.025769 | -0.044776 | 0.018121 |
| mtst | annualised_sharpe | -0.059205 | 0.254218 | -0.30405 | 0.326525 |
| mtst | per_trade_sharpe | 0.015275 | 0.059749 | -0.052875 | 0.10955 |
| mtst | exposure | 0.087625 | 0.008405 | 0.074175 | 0.09535 |
| mtst | max_drawdown | 0.168185 | 0.026437 | 0.136575 | 0.1899 |

## Per-fold spread across runs (mtst, outer validation)

| fold | metric | mean | std | min | max |
| --- | --- | --- | --- | --- | --- |
| 0 | macro_f1 | 0.1901 | 0.020049 | 0.173 | 0.2218 |
| 1 | macro_f1 | 0.15596 | 0.016051 | 0.1399 | 0.1768 |
| 2 | macro_f1 | 0.15406 | 0.01379 | 0.133 | 0.1661 |
| 3 | macro_f1 | 0.13374 | 0.019773 | 0.1096 | 0.1601 |
| 0 | directional_accuracy | 0.58892 | 0.122897 | 0.4854 | 0.7857 |
| 1 | directional_accuracy | 0.55502 | 0.036137 | 0.5 | 0.5959 |
| 2 | directional_accuracy | 0.47334 | 0.0148 | 0.4537 | 0.4881 |
| 3 | directional_accuracy | 0.50048 | 0.040378 | 0.445 | 0.5436 |
| 0 | coverage | 0.02158 | 0.023005 | 0.003 | 0.0585 |
| 1 | coverage | 0.03156 | 0.016588 | 0.0149 | 0.0532 |
| 2 | coverage | 0.04904 | 0.017345 | 0.0227 | 0.0657 |
| 3 | coverage | 0.03358 | 0.024058 | 0.0029 | 0.0627 |
| 0 | calibration_error | 0.18244 | 0.055776 | 0.0975 | 0.2353 |
| 1 | calibration_error | 0.09924 | 0.010222 | 0.0908 | 0.1161 |
| 2 | calibration_error | 0.08316 | 0.023324 | 0.0572 | 0.1096 |
| 3 | calibration_error | 0.0407 | 0.023418 | 0.0169 | 0.0796 |
| 0 | n_trades | 37.6 | 27.8262 | 7 | 76 |
| 1 | n_trades | 62.8 | 27.2158 | 34 | 91 |
| 2 | n_trades | 102.8 | 30.2688 | 50 | 123 |
| 3 | n_trades | 74.4 | 47.6844 | 12 | 133 |
| 0 | net_return | -0.037351 | 0.117522 | -0.22219 | 0.073657 |
| 1 | net_return | 0.194372 | 0.177818 | -0.012402 | 0.387633 |
| 2 | net_return | -0.180108 | 0.048724 | -0.249143 | -0.124785 |
| 3 | net_return | -0.054002 | 0.114081 | -0.19528 | 0.064764 |
| 0 | annualised_sharpe | -0.0556 | 1.26175 | -1.83 | 1.23 |
| 1 | annualised_sharpe | 1.4675 | 1.21622 | -0.0357 | 2.8977 |
| 2 | annualised_sharpe | -1.21422 | 0.384591 | -1.6279 | -0.6637 |
| 3 | annualised_sharpe | -0.4345 | 1.02196 | -1.6179 | 0.5376 |
| 0 | per_trade_sharpe | 0.08884 | 0.254745 | -0.1409 | 0.4769 |
| 1 | per_trade_sharpe | 0.13826 | 0.109044 | -0.0035 | 0.2789 |
| 2 | per_trade_sharpe | -0.10714 | 0.045891 | -0.1663 | -0.0473 |
| 3 | per_trade_sharpe | -0.05886 | 0.11934 | -0.2049 | 0.0349 |
| 0 | exposure | 0.04746 | 0.035166 | 0.0088 | 0.096 |
| 1 | exposure | 0.0793 | 0.034374 | 0.0429 | 0.1149 |
| 2 | exposure | 0.1298 | 0.038235 | 0.0631 | 0.1553 |
| 3 | exposure | 0.09394 | 0.060178 | 0.0152 | 0.1679 |
| 0 | max_drawdown | 0.13644 | 0.113952 | 0.0253 | 0.311 |
| 1 | max_drawdown | 0.08716 | 0.026514 | 0.052 | 0.1236 |
| 2 | max_drawdown | 0.28122 | 0.045873 | 0.2304 | 0.3494 |
| 3 | max_drawdown | 0.16792 | 0.059206 | 0.0869 | 0.243 |

## Selection stability (chosen on inner validation)

| fold | threshold mean | threshold std | threshold range | epoch mean | epoch std |
| --- | --- | --- | --- | --- | --- |
| 0 | 0.4120 | 0.0363 | 0.36–0.46 | 2.80 | 1.30 |
| 1 | 0.4600 | 0.0245 | 0.44–0.50 | 4.60 | 2.41 |
| 2 | 0.4440 | 0.0219 | 0.42–0.46 | 3.40 | 0.55 |
| 3 | 0.4960 | 0.0456 | 0.44–0.56 | 4.00 | 1.58 |

## Against the statistical / rule baselines

A floor test: did the model learn more than always predicting the majority class, or than following the trend? **Passing it is not evidence of profitability** — see the next section, which is the one that answers that.

MTST beat both baselines on net return in 20/20 run-folds, and in a majority of folds in 5/5 runs.

| run | folds won |
| --- | --- |
| btc_nested_v4_seed_42 | 4/4 |
| btc_nested_v4_seed_142 | 4/4 |
| btc_nested_v4_seed_242 | 4/4 |
| btc_nested_v4_seed_342 | 4/4 |
| btc_nested_v4_seed_442 | 4/4 |

## Against doing nothing

**CASH** — never trade, no fees — returns exactly 0. MTST's mean outer net return across all run-folds is **-0.019272**, so it **lost money** and beat doing nothing in 9/20 run-folds.

**Buy-and-hold** over the same windows, one round trip charged once, returned a mean **+0.606328**. MTST beat it in 0/20 run-folds where the reference was recorded.


## Dataset / sealed-test status

- Processed dataset: `data/datasets/binance_BTC_USDT_1h_refresh_2026-08-20.parquet`
...
- Research input: recomputed from this dataset and **matches** `sha256:1c09218442cdf98c` — the runs' recorded identity.
- Raw input: `sha256:8724f622e666ef1f` over 49551 candles through `2025-08-27T22:00:00+00:00` — the market statistics below can be reproduced from any file with that identity, not only from the local path above.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | -0.037351 | 0.117522 | -0.013370 | 2/5 | 0.5889±0.1229 | 0.0216±0.0230 | 37.6±27.8 | 0.4120±0.0363 | 0.36–0.46 | 2.80±1.30 |
| 1 | +0.194372 | 0.177818 | +0.172551 | 4/5 | 0.5550±0.0361 | 0.0316±0.0166 | 62.8±27.2 | 0.4600±0.0245 | 0.44–0.50 | 4.60±2.41 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | model | mtst net return | +0.194372 | -0.180108 | +0.37448 | +1.9266 |
...
| 6 | model | trades | +62.8 | +102.8 | -40 | -0.3891 |
| 7 | model | coverage | +0.03156 | +0.04904 | -0.01748 | -0.3564 |
| 8 | market | market max drawdown | +0.201837 | +0.305383 | -0.103546 | -0.3391 |
| 9 | volume | volume_change mean | +0.151282 | +0.187974 | -0.0366921 | -0.1952 |
| 10 | trend | ema_cross fraction positive | +0.62521 | +0.522096 | +0.103114 | +0.1649 |
| 11 | model | directional accuracy | +0.55502 | +0.47334 | +0.08168 | +0.1472 |
...
| 19 | model | selected threshold | +0.46 | +0.444 | +0.016 | +0.0348 |
| 20 | market | positive candle fraction | +0.520431 | +0.503837 | +0.0165941 | +0.0319 |
| 21 | market | mean abs hourly return | +0.00336091 | +0.00346278 | -0.00010187 | -0.0294 |
| 22 | volatility | realized_vol mean | +0.00462179 | +0.00476181 | -0.00014002 | -0.0294 |
...
| --- | --- | --- | --- | --- | --- | --- |
| LONG | 943 | 0.5345 | +0.000405 | +0.000896 | +0.381887 | 0.0208 |
| SHORT | 445 | 0.4382 | -0.001884 | -0.001615 | -0.838551 | 0.0132 |

HOLD / no-trade samples: 91477 of 94695.
...
1. **Fold 2 behaves consistently worse than fold 1 across every seed observed, so it is worth characterising as a regime rather than dismissed as noise — then replicated on independent periods and assets before the characterisation is generalised.**
   Coincides with: across 5 seed(s) fold 1 spans [-0.012402, +0.387633] and fold 2 spans [-0.249143, -0.124785] with no overlap, and fold 2 is negative in all 5 observed seeds. Consistent within these seeds; one fold per regime is still a sample of one, and seed count is not a substitute for independent periods (signal strength 1.9266).
...
3. **LONG and SHORT may need separate decision thresholds rather than one symmetric cut.**
   Coincides with: per-direction attribution is available and can be read directly; the selected threshold varies by up to 0.046 across seeds on a single fold. (signal strength 0.3564).
